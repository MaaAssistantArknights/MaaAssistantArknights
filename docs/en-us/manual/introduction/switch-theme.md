...
2. Enter candidate theme names in the task settings, as shown in the in-game theme list (e.g. ｢日间｣ for Day, ｢夜间｣ for Night on the CN server).
