...
3. Task Configuration
   ...
   Read [Integration - List of Task Types](../../protocol/integration.md#list-of-task-types) and modify the `asst.append_task(…)` function calls in `sample.py` according to your needs.
