...
1. Install MAA Dynamic Library
   ...
   2. Navigate to the extracted `Python/` directory and open the `sample.py` file
...
2. ADB Configuration
   1. Find the line [`if asst.connect("adb.exe", "127.0.0.1:5555"):`](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/dev-v2/src/Python/sample.py#L71)
...
3. Task Configuration
   ...
   Custom tasks: Refer to the [Integration Documentation](../../protocol/integration.md) and modify the [`# 任务及参数请参考 docs/zh-cn/protocol/integration.md`](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/dev-v2/src/Python/sample.py#L77) section in `sample.py`
