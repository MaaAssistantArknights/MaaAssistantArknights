...
Chinese or Arknights Edition MuMu 12 V4.0.0 and later versions are supported. Global Edition MuMu 12 V4.1.26 and later versions are supported. <!-- Chinese V3.8.13 -->
...
2. `MuMu12 Emulator exec path` Fill in the path to the `MuMuPlayer-12.0` or `YXArkNights-12.0` or `MuMuPlayerGlobal-12.0` folder. e.g. `C:\Program Files\Netease\MuMuPlayer-12.0`.
