...
이 튜토리얼에서는 일부 개념을 간소화하여 더 넓은 사용자들이 쉽게 접근할 수 있도록 설명되었습니다. 이를 위해 일부 우아함과 정확성이 희생되었을 수 있습니다. Git과 프로그래밍 지식에 익숙한 경우, 더 고급스러운 튜토리얼인 [개발 환경 구축](./development.md)을 참조하시기 바랍니다.
