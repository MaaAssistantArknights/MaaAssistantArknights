...
사용자 정의 작업: [통합 문서](../../스키마/1.연동.md)를 참조하여 `sample.py`의 # 작업 및 매개 변수는 [`문서/통합 문서.md`](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/722f0ddd4765715199a5dc90ea1bec2940322344/src/Python/sample.py#L54)를 참조하세요 줄을 수정하세요.
