...
사용자 정의 작업: [통합 문서](../../스키마/1.통합문서.md)를 참조하고, `sample.py`의 # 작업 및 매개 변수는 [통합 문서](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/722f0ddd4765715199a5dc90ea1bec2940322344/src/Python/sample.py#L54)를 참조해 줄을 수정하세요.
