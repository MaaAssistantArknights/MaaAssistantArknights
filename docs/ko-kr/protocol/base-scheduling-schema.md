  ...
  "plans": [
    {
      ...
      "Fiammetta": {
        // "Fiammetta"를 사용하는 오퍼레이터, 선택 사항. 사용하지 않는 경우 필요하지 않습니다.
      ...
      "drones": {
        // 드론 사용에 대한 정보입니다. 선택 사항이며, 지정하지 않으면 드론은 사용되지 않습니다.
      ...
      "rooms": {
        ...
        "control": [
          {
            "operators": [
              // 이 방에 할당된 오퍼레이터들입니다. OCR을 통해 식별되며 해당 클라이언트 언어로 오퍼레이터 이름을 전달해야 합니다.
              "夕",
              "令",
              "凯尔希",
              "阿米娅",
