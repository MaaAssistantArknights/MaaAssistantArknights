...
```json
{
  ...
  "opers": [
    // 오퍼레이터 목록
    {
      ...
      "requirements": {
        // 요구 사항, 예약된 필드이며 구현되지 않았습니다. 선택 사항이며 기본적으로 비어 있습니다.
  ...
  "groups": [
    {
      ...
      "opers": [
        // 랜덤하게 선택되는 오퍼레이터들로 이루어진 목록입니다. 위의 `opers` 필드와 유사합니다. 레벨이 높은 오퍼레이터일수록 높은 우선순위를 갖습니다.
        {
          "name": "夜莺", // Nightingale
          "skill": 3,
  ...
  "actions": [
    // 순차적으로 실행되는 작업들로 이루어진 목록입니다. 필수 입력 항목입니다.
    {
