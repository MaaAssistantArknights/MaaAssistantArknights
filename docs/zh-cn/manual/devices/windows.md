...
完美支持，需要在模拟器 \`设定\` - \`进阶\` 中打开 \`Android调试桥\`。已知兼容 Hyper-V。
...
`,
`
### ✅ [Google Play 游戏（开发者）](https://developer.android.com/games/playgames/emulator?hl=zh-cn)

完美支持，但测试较少。必须开启 Hyper-V，且必须登录谷歌账户。
`,
])
...
`,
`
### 🚫 [Google Play 游戏](https://play.google.com/googleplaygames)
