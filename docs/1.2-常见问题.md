...
- 不支持 DX12 的系统（win7, 8, 8.1, vista, win server 等），但 CPU 支持 AVX2，请下载 [NoDX12 Patch v4.8.1](https://ota.maa.plus/MaaAssistantArknights/MaaRelease/releases/download/v4.8.1/MAAPatch-NoDX12-v4.8.1.zip)，覆盖 MAA 目录下同名文件。如果走不了只能也放弃支持了。目前只有 4.8.1 可以使用
