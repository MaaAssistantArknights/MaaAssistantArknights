  ...
  "plans": [
    {
      ...
      "Fiammetta": {
        // “フィアメッタ” がどのオペレーターを配属するか、オプション、記入しない場合は配属しない。
      ...
      "groups": [
        // "control" / "manufacture" / "trading" の場合、オペレーターグループを設定できます
        {
          "name": "A",
          "operators": ["グム", "シルバーアッシュ", "メイ"]
        },
        {
          "name": "B",
          "operators": ["セイリュウ", "ユーネクテス", "ウィーディ"]
        }
      ],
      "rooms": {
        // 部屋情報，必須
        ...
        "manufacture": [
          ...
          },
          {
            "operators": ["ドロシー"],
            "candidates": [
              // サブオペレーター，オプション。埋まるまで、誰でも利用可能です
