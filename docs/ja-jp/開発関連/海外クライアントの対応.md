...
2. [タスクAPI](../プロトコルドキュメント/タスクAPI.md) を読み、各フィールドの意味と使い方の基本を理解していること。また、コード中の `@` と `#` の意味と使い方を理解しておくこと。
...
[Github Pull Requst ガイド](./開発を開始.md#github-pull-request-プロセス概要)を参照してください。
