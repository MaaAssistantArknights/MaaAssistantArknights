...
Gitの使用経験とプログラミングの基礎がある場合、[GitHub Pull Request プロセス概要](./development.md)など、より上級のチュートリアルを見ることができます。
:::
...
10. これでメインリポジトリに移動します。PRする内容を確認してください。  
    スクリーンショットのように、真ん中に左向きの矢印があり、右側の「個人名/MAA」のdev-v2ブランチを「メインリポジトリ/MAA」のdev-v2ブランチにマージすることを申請しています。
...
12. 大佬たちがさらに小さな問題を修正するように言った場合、あなたの個人のリポジトリに戻って、以前のdev-v2ブランチに切り替え、手順3-9を繰り返すだけで大丈夫です！  
