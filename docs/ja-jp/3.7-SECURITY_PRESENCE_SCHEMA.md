    ...
    "stages": [
        {
            "stage_name": "Swarm",         // Name of a single-level stage, required
                                           // Does not support stageId or levelId
...
[SSS_阿卡胡拉丛林.json](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/master/resource/copilot/SSS_阿卡胡拉丛林.json)<br>
