...
- MAA 在 5.0 版本更新到了 .NET 8，现已不支持 Windows 7 系统。若您执意要运行，则会出现内存占用异常的问题，请参阅 [#8238](https://github.com/MaaAssistantArknights/MaaAssistantArknights/issues/8238) 实施缓解措施。
...
- 我们无法提供重装系统以外的修复建议，请避免使用未标明精简项及精简风险的“精简版”系统。
