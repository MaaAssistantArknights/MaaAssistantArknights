...
::: info 注意
回調訊息隨版本更新快速迭代中，本文件可能過時。如需獲取最新内容可参考 [簡中文件](../3.2-回调消息协议.md) 或 [C# 集成源碼](https://github.com/MaaAssistantArknights/MaaAssistantArknights/blob/dev/src/MaaWpfGui/Main/AsstProxy.cs)
:::
...
- `StageDreadfulFoe`<br>
    肉鴿關卡：險路惡敵
- `StartGameTask`
    打開客戶端失敗（配置文件與傳入 client_type 不匹配）
- Todo 其他
