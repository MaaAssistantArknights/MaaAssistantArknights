...
[简体中文](/docs/) | [繁體中文](/docs/zh-tw/) | [English](/docs/en-us/) | [日本語](/docs/ja-jp/) | [한국어](/docs/ko-kr/)
...
5. （可选）若准备提交 PR，建议启用 [clang-format 支持](/docs/2.2-开发相关.md#在-visual-studio-中启用-clang-format)
...
请参考 [Issue bot 使用方法](/docs/2.3-IssueBot使用方法.md)
