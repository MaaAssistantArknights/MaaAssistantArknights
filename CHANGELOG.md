...
优化了自动编队中助战干员的处理逻辑，修复了多个干员组映射和缺失干员查找相关问题，提升了自动编队功能的稳定性。
...
#### Auto-Formation Support Unit Optimization

Optimized the support unit handling logic in auto-formation, fixed multiple issues related to operator group mapping and missing operator search, improving the stability of the auto-formation feature.
