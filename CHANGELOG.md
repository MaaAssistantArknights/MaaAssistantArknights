...
* 修复黑流树海临时中介所识别 ([#18004](https://github.com/MaaAssistantArknights/MaaAssistantArknights/pull/18004)) @youzibigg
...
* 修复自动战斗作业 `role` 字段的职业解析，未指定或未知职业名不再被误判为无人机职业，并兼容职业大小写 @status102 @ABA2396
* YostarKR fix ocrReplace regex for 烛煌 @HX3N
* YostarKR polish task-log strings and clue terminology @HX3N
