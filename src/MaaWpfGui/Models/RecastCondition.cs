...
public class RecastCondition : PropertyChangedBase
{
    ...
    {
        RecastConstants.MetricTypes.RecastCount => Helper.LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricCount"),
        RecastConstants.MetricTypes.Hp => Helper.LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricHp"),
        RecastConstants.MetricTypes.Hope => Helper.LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricHope"),
        RecastConstants.MetricTypes.Ingot => Helper.LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricIngot"),
        RecastConstants.MetricTypes.Ticket => Helper.LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricTicket"),
        _ => Metric,
    };
