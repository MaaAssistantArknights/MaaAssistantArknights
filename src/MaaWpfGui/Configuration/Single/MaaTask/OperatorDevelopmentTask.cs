// <copyright file="OperatorDevelopmentTask.cs" company="MaaAssistantArknights">
...
/// </summary>
public class OperatorDevelopmentTask : BaseTask
{
    public OperatorDevelopmentTask() => TaskType = TaskType.OperatorDevelopment;
