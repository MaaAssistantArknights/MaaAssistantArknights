...
namespace MaaWpfGui.Constants
{
    ...
    public static class ConfigurationKeys
    {
        ...
        public const string RoguelikeDifficulty = "Roguelike.Difficulty"; // 迁移
        public const string RoguelikeMode = "Roguelike.Mode"; // 迁移
        public const string RoguelikeSquad = "Roguelike.Squad"; // 迁移
        public const string RoguelikeRoles = "Roguelike.Roles"; // 迁移
        public const string RoguelikeCoreChar = "Roguelike.CoreChar"; // 迁移
        public const string RoguelikeStartWithEliteTwo = "Roguelike.RoguelikeStartWithEliteTwo"; // 迁移
        public const string RoguelikeOnlyStartWithEliteTwo = "Roguelike.RoguelikeOnlyStartWithEliteTwo"; // 迁移
        public const string Roguelike3FirstFloorFoldartal = "Roguelike.Roguelike3FirstFloorFoldartal"; // 迁移
        public const string Roguelike3StartFloorFoldartal = "Roguelike.Roguelike3StartFloorFoldartal"; // 迁移
        public const string Roguelike3NewSquad2StartingFoldartal = "Roguelike.Roguelike3NewSquad2StartingFoldartal"; // 迁移
        public const string Roguelike3NewSquad2StartingFoldartals = "Roguelike.Roguelike3NewSquad2StartingFoldartals"; // 迁移
        public const string RoguelikeExpectedCollapsalParadigms = "Roguelike.RoguelikeExpectedCollapsalParadigms";
        public const string RoguelikeUseSupportUnit = "Roguelike.RoguelikeUseSupportUnit"; // 迁移
        public const string RoguelikeEnableNonfriendSupport = "Roguelike.RoguelikeEnableNonfriendSupport"; // 迁移
        public const string RoguelikeDelayAbortUntilCombatComplete = "Roguelike.RoguelikeDelayAbortUntilCombatComplete";
        public const string RoguelikeStartsCount = "Roguelike.StartsCount"; // 迁移
        public const string RoguelikeInvestmentEnabled = "Roguelike.InvestmentEnabled"; // 迁移
        public const string RoguelikeInvestmentEnterSecondFloor = "Roguelike.InvestmentEnterSecondFloor"; // 迁移
        public const string RoguelikeRefreshTraderWithDice = "Roguelike.RefreshTraderWithDice"; // 迁移
        public const string RoguelikeInvestsCount = "Roguelike.InvestsCount"; // 迁移
        public const string RoguelikeStopWhenInvestmentFull = "Roguelike.StopWhenInvestmentFull"; // 迁移
        public const string RoguelikeDeploymentWithPause = "Roguelike.DeploymentWithPause";
        public const string RoguelikeStopAtFinalBoss = "Roguelike.ExitAtFinalBoss"; // 迁移
