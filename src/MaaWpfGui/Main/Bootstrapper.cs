...
public class Bootstrapper : Bootstrapper<RootViewModel>
{
    ...
    private static readonly Environment.SpecialFolder[] UnsupportedInstallLocationSpecialFolders =
    {
    ...
    {
        var paths = new HashSet<string>(StringComparer.OrdinalIgnoreCase);
        foreach (Environment.SpecialFolder specialFolder in UnsupportedInstallLocationSpecialFolders)
        {
