        ...
        private static bool ConvertV4ToV5()
        {
            ...
            foreach (var configName in ConfigurationHelper.GetConfigurationList())
            {
                ...
                // GUI部分
                {
                    ...
                    {
                        ConfigFactory.CurrentConfig.GUI.LogItemDateFormat = "MM-dd HH:mm:ss";
                    }
                ...
                // TaskQueue部分
                {
                    ...
                    awardTask.Award = bool.Parse(ConfigurationHelper.GetValue(ConfigurationKeys.ReceiveAward, true.ToString()));
                    awardTask.Mail = bool.Parse(ConfigurationHelper.GetValue(ConfigurationKeys.ReceiveMail, false.ToString()));
