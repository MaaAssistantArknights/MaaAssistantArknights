...
namespace MaaWpfGui.Helper
{
    public static class DataHelper
    {
        ...
        {
            string filePath = Path.Combine(PathsHelper.Resource, "battle_data.json");
        ...
        private static void InitRecruitTag()
        {
            ...
            var clientTags = ParseRecruit(Path.Combine(PathsHelper.Resource, clientPath, "recruitment.json"));
            var displayTags = ParseRecruit(Path.Combine(PathsHelper.Resource,  displayPath, "recruitment.json"));
        ...
        {
            MapData = [];
            var path = Path.Combine(PathsHelper.Resource, "Arknights-Tile-Pos", "overview.json");
            if (!File.Exists(path))
            {
                return;
            }
