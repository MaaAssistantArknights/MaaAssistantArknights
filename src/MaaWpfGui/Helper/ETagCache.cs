...
namespace MaaWpfGui.Helper
{
    public class ETagCache
    {
        ...
        private static readonly string _etagFile = Path.Combine(Environment.CurrentDirectory, MaaApiService.CacheDir + "etag.json");
        private static readonly string _lastModifiedFile = Path.Combine(Environment.CurrentDirectory, MaaApiService.CacheDir + "last_modified.json");
