...
namespace MaaWpfGui.Helper
{
    public class ETagCache
    {
        ...
        private static readonly string _etagFile = Path.Combine(PathsHelper.CacheDirectory, "etag.json");
        private static readonly string _lastModifiedFile = Path.Combine(PathsHelper.CacheDirectory, "last_modified.json");
