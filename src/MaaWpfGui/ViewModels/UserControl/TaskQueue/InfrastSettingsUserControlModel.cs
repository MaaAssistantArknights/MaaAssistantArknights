...
public class InfrastSettingsUserControlModel : TaskViewModel
{
    ...
    public override bool? SerializeTask(BaseTask baseTask, int? taskId = null)
    {
        ...
        var task = new AsstInfrastTask
        {
            ...
            DormFilterNotStationedEnabled = infrast.DormFilterNotStationedEnabled,
            DormDormTrustEnabled = infrast.DormTrustEnabled,
            OriginiumShardAutoReplenishment = infrast.OriginiumShardAutoReplenishment,
            ReceptionMessageBoard = infrast.ReceptionMessageBoardReceive,
            Filename = infrast.CustomInfrastFile,
            PlanIndex = infrast.CustomInfrastPlanIndex,
        };
        if (taskId is { } id)
        {
