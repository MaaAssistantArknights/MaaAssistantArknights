...
public class MiniGameRecastUserControlModel : PropertyChangedBase
{
    ...
    [
        new() { Display = LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricCount"), Value = RecastConstants.MetricTypes.RecastCount },
        new() { Display = LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricHp"), Value = RecastConstants.MetricTypes.Hp },
        new() { Display = LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricHope"), Value = RecastConstants.MetricTypes.Hope },
        new() { Display = LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricIngot"), Value = RecastConstants.MetricTypes.Ingot },
        new() { Display = LocalizationHelper.GetString("MiniGameNameRoguelikeCoppersRecastMetricTicket"), Value = RecastConstants.MetricTypes.Ticket },
    ];
