...
namespace asst
{
    ...
    protected:
        ...
        virtual bool click_filter_menu();// 点击干员选择页面的筛选菜单按钮
        virtual bool click_filter_menu_not_stationed_button();// 点击干员选择页面的筛选菜单的“未进驻”按钮
        virtual bool click_filter_menu_confirm_button();// 点击干员选择页面的筛选菜单的“确认”按钮
