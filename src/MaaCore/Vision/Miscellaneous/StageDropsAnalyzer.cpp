...
bool StageDropsAnalyzer::analyze()
{
    LogTraceFunction;
...
StageKey StageDropsAnalyzer::get_stage_key() const
{
    return { m_stage_code, m_difficulty };
}

int StageDropsAnalyzer::get_stars() const noexcept
{
    return m_stars;
}

bool StageDropsAnalyzer::analyze_stage_code()
{
    LogTraceFunction;
...
bool StageDropsAnalyzer::analyze_stars()
{
    LogTraceFunction;
...
bool StageDropsAnalyzer::analyze_difficulty()
{
    LogTraceFunction;
...
bool StageDropsAnalyzer::analyze_drops()
{
    LogTraceFunction;
...
bool StageDropsAnalyzer::analyze_drops_for_CF()
{
...
bool StageDropsAnalyzer::analyze_drops_for_12()
{
...
bool StageDropsAnalyzer::analyze_baseline()
{
    LogTraceFunction;
...
StageDropType StageDropsAnalyzer::match_droptype(const Rect& roi)
{
    LogTraceFunction;
...
std::string StageDropsAnalyzer::match_item(const Rect& roi, StageDropType type, int index, int size)
{
    LogTraceFunction;
                                                                       ...
                                                                       bool use_word_model)
{
    ...
    // ref: DepotAnalyzer::match_quantity
    cv::Mat quotient;
