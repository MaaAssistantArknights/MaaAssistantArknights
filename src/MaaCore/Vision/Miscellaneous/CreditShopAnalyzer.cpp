...
void CreditShopAnalyzer::set_black_list(std::vector<std::string> black_list)
{
...
void CreditShopAnalyzer::set_white_list(std::vector<std::string> black_list)
{
    Log.info(__FUNCTION__, black_list);
...
bool CreditShopAnalyzer::analyze()
{
    m_commodities.clear();
    m_need_to_buy.clear();
    m_result.clear();
...
bool CreditShopAnalyzer::commodities_analyze()
{
    // 识别信用点的图标
...
bool CreditShopAnalyzer::whether_to_buy_analyze()
{
