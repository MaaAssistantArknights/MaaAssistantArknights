...
//         return std::abs(lhs.rect.y - rhs.rect.y) < 5 ? return lhs.rect.x < rhs.rect.x : return lhs.rect.y <
//         rhs.rect.y;
//     });
// }
//
...
//         return std::abs(lhs.rect.x - rhs.rect.x) < 5 ? return lhs.rect.y < rhs.rect.y : return lhs.rect.x <
//         rhs.rect.x;
//     });
// }
//
