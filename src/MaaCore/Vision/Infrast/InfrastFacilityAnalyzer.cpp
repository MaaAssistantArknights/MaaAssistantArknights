#include "InfrastFacilityAnalyzer.h"
...
bool InfrastFacilityAnalyzer::analyze()
{
    ...
    for (const auto& key : m_to_be_analyzed) {
        ...
        MultiMatcher::ResultsVecOpt cur_facility_result;
        ...
        int index = 0;
        for (const auto& mr : *cur_facility_result) {
