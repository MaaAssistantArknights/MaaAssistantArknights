...
bool InfrastOperAnalyzer::analyze()
{
    m_result.clear();
...
void InfrastOperAnalyzer::sort_by_loc()
{
    LogTraceFunction;
...
void InfrastOperAnalyzer::sort_by_mood()
{
    LogTraceFunction;
...
void InfrastOperAnalyzer::oper_detect()
{
    LogTraceFunction;
    ...
    InfrastSmileyAnalyzer smiley_analyzer(m_image);
...
void InfrastOperAnalyzer::mood_analyze()
{
    LogTraceFunction;
...
void InfrastOperAnalyzer::face_hash_analyze()
{
    LogTraceFunction;
...
void InfrastOperAnalyzer::skill_analyze()
{
    LogTraceFunction;
    ...
    auto&& [l, u] = task_ptr->mask_range;
    skill_analyzer.set_mask_range(l, u);
    ...
    for (auto&& oper : m_result) {
        ...
        for (int i = 0; i != MaxNumOfSkills; ++i) {
            ...
            std::vector<std::pair<infrast::Skill, Matcher::Result>> possible_skills;
...
void InfrastOperAnalyzer::selected_analyze()
{
    LogTraceFunction;
...
void InfrastOperAnalyzer::doing_analyze()
{
    LogTraceFunction;
