...
#include "Task/Roguelike/Map/RoguelikeBlackflowRoutingTaskPlugin.h"
    ...
    m_config_ptr(std::make_shared<RoguelikeConfig>())
{
    ...
    m_roguelike_task_ptr->register_plugin<RoguelikeBlackflowRoutingTaskPlugin>(m_config_ptr, m_control_ptr);
