...
#include "Task/Roguelike/Map/RoguelikeDrowningSeekersRoutingTaskPlugin.h"
    ...
    m_config_ptr(std::make_shared<RoguelikeConfig>())
{
    ...
    m_roguelike_task_ptr->register_plugin<RoguelikeDrowningSeekersRoutingTaskPlugin>(m_config_ptr, m_control_ptr);
