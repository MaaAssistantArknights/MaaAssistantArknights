...
void asst::RoguelikeFormationTaskPlugin::clear_and_reselect()
{
    ...
    std::vector<asst::RoguelikeFormationAnalyzer::FormationOper> sorted_oper_list;
...
bool asst::RoguelikeFormationTaskPlugin::select(asst::RoguelikeFormationAnalyzer::FormationOper oper)
{
