...
namespace asst
{
    ...
    public:
        ...
        void set_start_foldartal_list(std::string string) { m_start_foldartal_list = string; }
        std::string get_start_foldartal_list() const { return m_start_foldartal_list; }
    ...
    private:
        ...
        std::string m_start_foldartal_list;        // 需要凹的板子
