...
internal static class SettingsOptionCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> LocalizedTexts =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["AttachWindowScreencapPrintWindow"] = BuildText("PrintWindow（后台，备用1）", "PrintWindow (Background, Backup 1)", "PrintWindow（背景，備用1）", "PrintWindow（バックグラウンド、予備1）", "PrintWindow (백그라운드, 대체 1)"),
            ["AttachWindowScreencapScreenDC"] = BuildText("ScreenDC（后台，备用2）", "ScreenDC (Background, Backup 2)", "ScreenDC（背景，備用2）", "ScreenDC（バックグラウンド、予備2）", "ScreenDC (백그라운드, 대체 2)"),
            ...
            ["AttachWindowInputSendWithCursor"] = BuildText("SendMessageWithCursor（半后台，备用）", "SendMessageWithCursor (Semi-background, Backup)", "SendMessageWithCursor（半背景，備用）", "SendMessageWithCursor（半バックグラウンド、予備）", "SendMessageWithCursor (준 백그라운드, 대체)"),
            ...
            ["AttachWindowInputSendWithWindowPos"] = BuildText("SendMessageWithWindowPos（后台窗口，备用）", "SendMessageWithWindowPos (Background Window, Backup)", "SendMessageWithWindowPos（背景視窗，備用）", "SendMessageWithWindowPos（バックグラウンドウィンドウ、予備）", "SendMessageWithWindowPos (백그라운드 창, 대체)"),
