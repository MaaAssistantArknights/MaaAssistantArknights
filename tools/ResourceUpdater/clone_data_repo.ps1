...
Remove-Item Overseas -Recurse -Force

Write-Host "ArknightsGameResource - Official"
git clone --filter=blob:none --no-checkout --depth 1 --sparse https://github.com/yuanyan3060/ArknightsGameResource Official
...
git clone --filter=blob:none --no-checkout --depth 1 --sparse https://github.com/Kengxxiao/ArknightsGameData_Yostar Overseas
...
git clone --filter=blob:none --no-checkout --depth 1 --sparse -b data-tw https://github.com/arkntools/arknights-toolbox-update zh_TW/gamedata/excel
