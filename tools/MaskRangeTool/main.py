...
if __name__ == '__main__':
    ...
    # image = cv2.imread(str(maa_dir / "resource" / "template" / "StartToVisit.png"))
    ...
    image = cv2.imread(str(maa_dir / "resource" / "template" / "StartToVisit.png"))
    mask_ranges = [[[250, 250, 250], [255, 255, 255]]]
    ...
    image1 = cv2.imread(str(maa_dir / "resource" / "template" / "StartToVisit.png"))
    image2 = cv2.imread(str(maa_dir / "resource" / "template" / "StartToVisitDetermine.png"))
    mask_ranges = [[[250, 250, 250], [255, 255, 255]]]
